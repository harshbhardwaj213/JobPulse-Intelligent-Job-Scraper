...
def get_record(card):
    ...
    summary = card.find_element(By.CLASS_NAME, 'summary').text
    job_url = card.find_element(By.CLASS_NAME, 'jobtitle').get_attribute('href')
...
def main(position, location):
    ...
    while True:
        cards = driver.find_elements(By.CLASS_NAME, 'jobsearch-SerpJobCard')
        ...
        try:
            ...
            logging.error(f"Popup interaction error: {e}")
